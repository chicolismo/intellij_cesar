...
public class ButtonPanel extends JPanel {
    ...
    static {
        ...
        try {
            icon = ImageIO.read(ButtonPanel.class.getResourceAsStream("/cesar/resources/images/config.png"));
            next = ImageIO.read(ButtonPanel.class.getResourceAsStream("/cesar/resources/images/tools.png"));
        }

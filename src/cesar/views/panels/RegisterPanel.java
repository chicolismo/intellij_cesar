...
public class RegisterPanel extends JPanel {
    ...
    static {
        ...
        try {
            computerIcon = ImageIO.read(
                    RegisterPanel.class.getResourceAsStream(Properties.getProperty("RegisterPanel.computerIconPath")));
            alternativeIcon = ImageIO.read(RegisterPanel.class
                    .getResourceAsStream(Properties.getProperty("RegisterPanel.alternativeIconPath")));
        }
